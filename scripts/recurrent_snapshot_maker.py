...
ap.add_argument(
    "--input",
    dest="video_path",
    help="If using OpenCV camera, path to video or 0 for webcam input",
)
ap.add_argument(
    "--output",
...
ap.add_argument(
    ...
    type=int,
    default=30000,
    help="Camera tries getting a frame for ms after the last successful trial",
)
ap.add_argument(
    "--config",
...
ap.add_argument(
    ...
    "--dry-run",
    dest="dry_run",
    help="Display what would happend but dont actually do it",
    default=False,
    action="store_true",
)
...
gp.add_argument(
    "--maxframes", type=int, default=math.inf, help="Camera fetches frames (s)"
)
